const local: App.I18n.Schema = {
  system: {
    title: 'ForumFlow Community Admin',
  ...
  page: {
    ...
    about: {
      title: 'About',
      introduction: `ForumFlow is an operations dashboard for forums and content communities, covering moderation, users and roles, forum settings, notices, analytics, and profiles.`,
      projectInfo: {
        title: 'Project Info',
        version: 'Version',
    ...
    home: {
      ...
      projectNews: {
        title: 'Project News',
        moreNews: 'More News',
        desc1: 'ForumFlow is connected to a deterministic demo dataset.',
        desc2: 'The content moderation permission matrix has been verified.',
        desc3: 'The read-only experience for community users is ready.',
        desc4: 'Rich text content is sanitized and restricted by an iframe allowlist.',
        desc5: 'Core routes are adapted for mobile layouts.'
      },
