const local: App.I18n.Schema = {
  ...
  page: {
    ...
    about: {
      title: '关于',
      introduction: `ForumFlow 是面向论坛与内容社区的运营管理平台，覆盖内容审核、用户与角色管理、板块配置、公告管理、数据看板和个人中心。`,
      projectInfo: {
        title: '项目信息',
        version: '版本',
    ...
    home: {
      ...
      projectNews: {
        title: '项目动态',
        moreNews: '更多动态',
        desc1: 'ForumFlow 已完成固定演示数据接入。',
        desc2: '内容审核模块已完成权限矩阵验证。',
        desc3: '普通用户只读体验已完成适配。',
        desc4: '富文本内容已接入安全净化和域名白名单。',
        desc5: '移动端页面已完成核心路由适配。'
      },
      creativity: '创意'
    },
    function: {
